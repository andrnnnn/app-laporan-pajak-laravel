    ...
    <script>
        $(document).ready(function() {
            ...
            function formatRupiah(angka) {
                let number = parseFloat(angka); // Pastikan angka tetap dalam bentuk numerik
                if (isNaN(number)) return "Rp 0"; // Jika bukan angka, tampilkan Rp 0

                return new Intl.NumberFormat("id-ID", {
                    style: "currency",
                    currency: "IDR",
                    minimumFractionDigits: 0, // Tidak menampilkan desimal jika nol
                    maximumFractionDigits: 2, // Batas maksimal desimal 2 digit
                }).format(number);
            }
        });
    </script>
